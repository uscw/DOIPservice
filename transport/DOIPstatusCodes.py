...
class status_codes(object):
    ...
    def __init__(self):
        ...
        self.codes = {
            ...
            # The client_old did not successfully authenticate.
            "unauthenticated"               : "0.DOIP/Status.102",
            # The client_old successfully authenticated, but is unauthorized to invoke the operation.
            "unauthorized"                  : "0.DOIP/Status.103",
            # The digital object is not known to the service to exist.
            "object_unknown"                : "0.DOIP/Status.104",
            # The client_old tried to create a new digital object with an identifier already in use by an existing digital object.
